...
export default function DownloadCTA({ className = '', size = 'lg' }: DownloadCTAProps) {
  ...
  return (
    <a
      ...
      className={`inline-flex items-center ${sizeClasses} bg-[#5A4898] hover:bg-[#4a3b80] text-white font-semibold rounded-xl transition-all duration-200 hover:scale-105 ${className}`}
    >
      {/* Apple logo SVG */}
